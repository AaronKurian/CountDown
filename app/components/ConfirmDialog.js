    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-black opacity-90 p-6 rounded-lg shadow-lg  w-80 sm:w-100 border-2 border-slate-300">
        ...
        <div className="flex justify-center items-center gap-6 ">
          <button
            onClick={onConfirm}
            className="w-24 cursor-pointer rounded bg-red-600 px-4 py-2 font-semibold text-white hover:bg-red-700"
          >
            Yes
          </button>
          <button
            onClick={onClose}
            className="w-24 cursor-pointer rounded bg-gray-300 px-4 py-2 font-semibold text-black hover:bg-gray-400"
          >
            No
          </button>
        </div>
